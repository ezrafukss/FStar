  ...
  fun env  ->
    fun s  ->
      let rec push x rest =
        ...
        | [] -> [x]
        | local::rest -> let uu____4405 = push x rest in local :: uu____4405 in
      let uu___116_4407 = env in
      let uu____4408 = push s env.gamma in
      {
        solver = (uu___116_4407.solver);
        range = (uu___116_4407.range);
        curmodule = (uu___116_4407.curmodule);
        gamma = uu____4408;
        gamma_cache = (uu___116_4407.gamma_cache);
        modules = (uu___116_4407.modules);
        expected_typ = (uu___116_4407.expected_typ);
        sigtab = (uu___116_4407.sigtab);
        is_pattern = (uu___116_4407.is_pattern);
        instantiate_imp = (uu___116_4407.instantiate_imp);
        effects = (uu___116_4407.effects);
        generalize = (uu___116_4407.generalize);
        letrecs = (uu___116_4407.letrecs);
        top_level = (uu___116_4407.top_level);
        check_uvars = (uu___116_4407.check_uvars);
        use_eq = (uu___116_4407.use_eq);
        is_iface = (uu___116_4407.is_iface);
        admit = (uu___116_4407.admit);
        lax = (uu___116_4407.lax);
        lax_universes = (uu___116_4407.lax_universes);
        type_of = (uu___116_4407.type_of);
        universe_of = (uu___116_4407.universe_of);
        use_bv_sorts = (uu___116_4407.use_bv_sorts);
        qname_and_index = (uu___116_4407.qname_and_index)
      }
...
let push_local_binding: env -> binding -> env =
  fun env  ->
    fun b  ->
      let uu___117_4435 = env in
      {
        solver = (uu___117_4435.solver);
        range = (uu___117_4435.range);
        curmodule = (uu___117_4435.curmodule);
        gamma = (b :: (env.gamma));
        gamma_cache = (uu___117_4435.gamma_cache);
        modules = (uu___117_4435.modules);
        expected_typ = (uu___117_4435.expected_typ);
        sigtab = (uu___117_4435.sigtab);
        is_pattern = (uu___117_4435.is_pattern);
        instantiate_imp = (uu___117_4435.instantiate_imp);
        effects = (uu___117_4435.effects);
        generalize = (uu___117_4435.generalize);
        letrecs = (uu___117_4435.letrecs);
        top_level = (uu___117_4435.top_level);
        check_uvars = (uu___117_4435.check_uvars);
        use_eq = (uu___117_4435.use_eq);
        is_iface = (uu___117_4435.is_iface);
        admit = (uu___117_4435.admit);
        lax = (uu___117_4435.lax);
        lax_universes = (uu___117_4435.lax_universes);
        type_of = (uu___117_4435.type_of);
        universe_of = (uu___117_4435.universe_of);
        use_bv_sorts = (uu___117_4435.use_bv_sorts);
        qname_and_index = (uu___117_4435.qname_and_index)
      }
  ...
  fun env  ->
    fun bs  ->
      FStar_List.fold_left
        (fun env  ->
           fun uu____4451  ->
             match uu____4451 with | (x,uu____4455) -> push_bv env x) env bs
let binding_of_lb:
  ...
  fun x  ->
    fun t  ->
      ...
      | FStar_Util.Inl x ->
          let x =
            let uu___118_4475 = x in
            {
              FStar_Syntax_Syntax.ppname =
                (uu___118_4475.FStar_Syntax_Syntax.ppname);
              FStar_Syntax_Syntax.index =
                (uu___118_4475.FStar_Syntax_Syntax.index);
...
let push_module: env -> FStar_Syntax_Syntax.modul -> env =
  fun env  ->
    fun m  ->
      ...
      (let uu___119_4505 = env in
       {
         solver = (uu___119_4505.solver);
         range = (uu___119_4505.range);
         curmodule = (uu___119_4505.curmodule);
         gamma = [];
         gamma_cache = (uu___119_4505.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = None;
         sigtab = (uu___119_4505.sigtab);
         is_pattern = (uu___119_4505.is_pattern);
         instantiate_imp = (uu___119_4505.instantiate_imp);
         effects = (uu___119_4505.effects);
         generalize = (uu___119_4505.generalize);
         letrecs = (uu___119_4505.letrecs);
         top_level = (uu___119_4505.top_level);
         check_uvars = (uu___119_4505.check_uvars);
         use_eq = (uu___119_4505.use_eq);
         is_iface = (uu___119_4505.is_iface);
         admit = (uu___119_4505.admit);
         lax = (uu___119_4505.lax);
         lax_universes = (uu___119_4505.lax_universes);
         type_of = (uu___119_4505.type_of);
         universe_of = (uu___119_4505.universe_of);
         use_bv_sorts = (uu___119_4505.use_bv_sorts);
         qname_and_index = (uu___119_4505.qname_and_index)
       })
...
let set_expected_typ: env -> FStar_Syntax_Syntax.typ -> env =
  fun env  ->
    fun t  ->
      let uu___120_4520 = env in
      {
        solver = (uu___120_4520.solver);
        range = (uu___120_4520.range);
        curmodule = (uu___120_4520.curmodule);
        gamma = (uu___120_4520.gamma);
        gamma_cache = (uu___120_4520.gamma_cache);
        modules = (uu___120_4520.modules);
        expected_typ = (Some t);
        sigtab = (uu___120_4520.sigtab);
        is_pattern = (uu___120_4520.is_pattern);
        instantiate_imp = (uu___120_4520.instantiate_imp);
        effects = (uu___120_4520.effects);
        generalize = (uu___120_4520.generalize);
        letrecs = (uu___120_4520.letrecs);
        top_level = (uu___120_4520.top_level);
        check_uvars = (uu___120_4520.check_uvars);
        use_eq = false;
        is_iface = (uu___120_4520.is_iface);
        admit = (uu___120_4520.admit);
        lax = (uu___120_4520.lax);
        lax_universes = (uu___120_4520.lax_universes);
        type_of = (uu___120_4520.type_of);
        universe_of = (uu___120_4520.universe_of);
        use_bv_sorts = (uu___120_4520.use_bv_sorts);
        qname_and_index = (uu___120_4520.qname_and_index)
      }
...
let clear_expected_typ: env -> (env* FStar_Syntax_Syntax.typ Prims.option) =
  fun env_  ->
    let uu____4536 = expected_typ env_ in
    ((let uu___121_4539 = env_ in
      {
        solver = (uu___121_4539.solver);
        range = (uu___121_4539.range);
        curmodule = (uu___121_4539.curmodule);
        gamma = (uu___121_4539.gamma);
        gamma_cache = (uu___121_4539.gamma_cache);
        modules = (uu___121_4539.modules);
        expected_typ = None;
        sigtab = (uu___121_4539.sigtab);
        is_pattern = (uu___121_4539.is_pattern);
        instantiate_imp = (uu___121_4539.instantiate_imp);
        effects = (uu___121_4539.effects);
        generalize = (uu___121_4539.generalize);
        letrecs = (uu___121_4539.letrecs);
        top_level = (uu___121_4539.top_level);
        check_uvars = (uu___121_4539.check_uvars);
        use_eq = false;
        is_iface = (uu___121_4539.is_iface);
        admit = (uu___121_4539.admit);
        lax = (uu___121_4539.lax);
        lax_universes = (uu___121_4539.lax_universes);
        type_of = (uu___121_4539.type_of);
        universe_of = (uu___121_4539.universe_of);
        use_bv_sorts = (uu___121_4539.use_bv_sorts);
        qname_and_index = (uu___121_4539.qname_and_index)
      }), uu____4536)
        ...
        then
          let uu____4550 =
            FStar_All.pipe_right env.gamma
              (FStar_List.collect
                 (fun uu___103_4554  ->
                    match uu___103_4554 with
                    | Binding_sig (uu____4556,se) -> [se]
                    | uu____4560 -> [])) in
          FStar_All.pipe_right uu____4550 FStar_List.rev
        else m.FStar_Syntax_Syntax.exports in
      add_sigelts env sigs;
      (let uu___122_4565 = env in
       {
         solver = (uu___122_4565.solver);
         range = (uu___122_4565.range);
         curmodule = empty_lid;
         gamma = [];
         gamma_cache = (uu___122_4565.gamma_cache);
         modules = (m :: (env.modules));
         expected_typ = (uu___122_4565.expected_typ);
         sigtab = (uu___122_4565.sigtab);
         is_pattern = (uu___122_4565.is_pattern);
         instantiate_imp = (uu___122_4565.instantiate_imp);
         effects = (uu___122_4565.effects);
         generalize = (uu___122_4565.generalize);
         letrecs = (uu___122_4565.letrecs);
         top_level = (uu___122_4565.top_level);
         check_uvars = (uu___122_4565.check_uvars);
         use_eq = (uu___122_4565.use_eq);
         is_iface = (uu___122_4565.is_iface);
         admit = (uu___122_4565.admit);
         lax = (uu___122_4565.lax);
         lax_universes = (uu___122_4565.lax_universes);
         type_of = (uu___122_4565.type_of);
         universe_of = (uu___122_4565.universe_of);
         use_bv_sorts = (uu___122_4565.use_bv_sorts);
         qname_and_index = (uu___122_4565.qname_and_index)
       })
let uvars_in_env:
  ...
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (Binding_univ uu____4615)::tl -> aux out tl
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl ->
          let uu____4630 =
            let uu____4634 = FStar_Syntax_Free.uvars t in ext out uu____4634 in
          aux uu____4630 tl
    ...
    let rec aux out g =
      ...
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl ->
          let uu____4690 =
            let uu____4692 = FStar_Syntax_Free.univs t in ext out uu____4692 in
          aux uu____4690 tl
      | (Binding_sig uu____4694)::uu____4695 -> out in
...
let univnames: env -> FStar_Syntax_Syntax.univ_name FStar_Util.set =
  fun env  ->
    ...
    let rec aux out g =
      match g with
      | [] -> out
      | (Binding_sig_inst uu____4732)::tl -> aux out tl
      | (Binding_univ uname)::tl ->
          let uu____4742 = FStar_Util.set_add uname out in aux uu____4742 tl
      | (Binding_lid (_,(_,t)))::tl|(Binding_var
        { FStar_Syntax_Syntax.ppname = _; FStar_Syntax_Syntax.index = _;
          FStar_Syntax_Syntax.sort = t;_})::tl ->
          let uu____4756 =
            let uu____4758 = FStar_Syntax_Free.univnames t in
            ext out uu____4758 in
          aux uu____4756 tl
      | (Binding_sig uu____4760)::uu____4761 -> out in
...
let binders_of_bindings:
  ...
  fun bs  ->
    let uu____4789 =
      let uu____4791 = bound_vars_of_bindings bs in
      FStar_All.pipe_right uu____4791
        (FStar_List.map FStar_Syntax_Syntax.mk_binder) in
    FStar_All.pipe_right uu____4789 FStar_List.rev
  ...
  fun env  ->
    let keys =
      FStar_List.fold_left
        (fun keys  ->
           fun uu___105_4842  ->
             match uu___105_4842 with
             | Binding_sig (lids,uu____4846) -> FStar_List.append lids keys
             | uu____4849 -> keys) [] env.gamma in
...
let dummy_solver: solver_t =
  {
    ...
    pop = (fun uu____4857  -> ());
    mark = (fun uu____4858  -> ());
    reset_mark = (fun uu____4859  -> ());
    commit_mark = (fun uu____4860  -> ());
    encode_modul = (fun uu____4861  -> fun uu____4862  -> ());
    encode_sig = (fun uu____4863  -> fun uu____4864  -> ());
    solve = (fun uu____4865  -> fun uu____4866  -> fun uu____4867  -> ());
    is_trivial = (fun uu____4871  -> fun uu____4872  -> false);
    finish = (fun uu____4873  -> ());
    refresh = (fun uu____4874  -> ())
  }