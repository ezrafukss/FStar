          ...
          let x =
            ...
            then "?"
              ...
              (let uu____400 = FStar_Unionfind.uvar_id u in
               FStar_All.pipe_right uu____400 FStar_Util.string_of_int) in
          ...
          let x =
            ...
            then "?"
              ...
              (let uu____411 = FStar_Unionfind.uvar_id u in
               FStar_All.pipe_right uu____411 FStar_Util.string_of_int) in
          let uu____415 = FStar_TypeChecker_Normalize.term_to_string env t in
    ...
    FStar_All.pipe_right args
      (FStar_List.map
         (fun uu____460  ->
            ...
            | (x,uu____464) -> FStar_Syntax_Print.term_to_string x)) in
      ...
      FStar_Util.find_map s
        (fun uu___113_941  ->
           ...
           | TERM ((u,uu____947),t) ->
               ...
               if uu____951 then Some t else None)
let find_univ_uvar:
      ...
      FStar_Util.find_map s
        (fun uu___114_970  ->
           ...
           | UNIV (u',t) ->
               ...
               if uu____974 then Some t else None
           | uu____978 -> None)
let whnf:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.term -> FStar_Syntax_Syntax.term
    ...
    fun t  ->
      let uu____985 =
        ...
        FStar_TypeChecker_Normalize.normalize
          ...
          FStar_TypeChecker_Normalize.WHNF] env uu____986 in
      ...
      let uu____1483 =
        let uu____1485 =
          FStar_All.pipe_right wl.wl_deferred
            (FStar_List.map
               (fun uu____1495  ->
                  match uu____1495 with | (uu____1499,uu____1500,x) -> x)) in
      ...
      fun t  ->
          ...
          | FStar_Syntax_Syntax.Tm_arrow (bs,c) ->
              ...
              then
                ...
                (let uu____1584 = FStar_Syntax_Util.abs_formals t in
                 ...
                 | (ys',t,uu____1605) ->
                     let uu____1618 = FStar_Syntax_Util.arrow_formals_comp k in
        ...
        | ((ys,t),(xs,c)) ->
            ...
            then
              ...
              (let c =
                 let uu____1701 = FStar_Syntax_Util.rename_binders xs ys in
               ...
               let uu____1703 =
                 ...
                 FStar_All.pipe_right uu____1710 (fun _0_33  -> Some _0_33) in
      ...
      fun wl  ->
        (let uu____1811 =
         ...
         then
           ...
           let uu____1813 =
             let uu____1814 = FStar_List.map (uvi_to_string wl.tcenv) sol in
        ...
        fun wl  ->
          ...
          (let uu____1862 =
           ...
           then
             ...
             let uu____1864 =
               let uu____1865 = FStar_List.map (uvi_to_string wl.tcenv) uvis in
               FStar_All.pipe_right uu____1865 (FStar_String.concat ", ") in
...
let occurs_check env wl uk t =
  ...
  let msg =
    ...
    then None
      ...
      (let uu____1972 =
         let uu____1973 = FStar_Syntax_Print.uvar_to_string (Prims.fst uk) in
              ...
              | ((isect,isect_set),(x,imp)) ->
                  ...
                  then (isect, isect_set)
                    ...
                    (let fvs =
                     ...
                     if uu____2189
                     then
                       let uu____2196 = FStar_Util.set_add x isect_set in
        ...
        FStar_All.pipe_right seen
          (FStar_Util.for_some
             (fun uu____2330  ->
                ...
                | (b,uu____2334) -> FStar_Syntax_Syntax.bv_eq a b)) in
      if uu____2324 then None else Some (a, (Prims.snd hd))
  | uu____2343 -> None
let rec pat_vars:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.bv* FStar_Syntax_Syntax.aqual) Prims.list ->
      ...
      fun t2  ->
        ...
        | (FStar_Syntax_Syntax.Tm_uvar
           (uv,uu____2907),FStar_Syntax_Syntax.Tm_uvar (uv',uu____2909)) ->
            ...
            if uu____2934 then FullMatch else MisMatch (None, None)
        ...
        | (FStar_Syntax_Syntax.Tm_refine (x,uu____2955),uu____2956) ->
            let uu____2961 = head_matches env x.FStar_Syntax_Syntax.sort t2 in
            FStar_All.pipe_right uu____2961 head_match
        | (uu____2962,FStar_Syntax_Syntax.Tm_refine (x,uu____2964)) ->
            let uu____2969 = head_matches env t1 x.FStar_Syntax_Syntax.sort in
      ...
      (_,Some (FStar_Syntax_Syntax.Delta_equational )) ->
        ...
        then fail r
          ...
          (let uu____3220 =
             ...
             let uu____3227 = maybe_inline t2 in (uu____3225, uu____3227) in
    ...
    | q::qs ->
        let uu____4070 =
              ...
              (match uu____4098 with
               | (T (gi_xs,uu____4114),prob) ->
                   let uu____4124 =
                     ...
                     FStar_All.pipe_left (fun _0_36  -> C _0_36) uu____4125 in
                   (uu____4124, [prob])
              ...
              (match uu____4154 with
               | (T (gi_xs,uu____4170),prob) ->
                   let uu____4180 =
                     ...
                     FStar_All.pipe_left (fun _0_37  -> C _0_37) uu____4181 in
                   (uu____4180, [prob])
          ...
          | uu____4318 ->
              ...
              (match uu____4325 with | (ktec,prob) -> (ktec, [prob])) in
                   ...
                   | (sub_probs,tcs,f) ->
                       let f =
                         ...
                         | Some b ->
                             ...
                             FStar_Syntax_Util.mk_conj_l uu____4478 in
                          ...
                          (match uu____4674 with
                           | (b,ref_opt) ->
                               (match ref_opt with
                                ...
                                | uu____4714 ->
                                    let rank =
                                      let uu____4721 = is_top_level_prob prob in
                                      if uu____4721
                                      then flex_refine
                     ...
                     | (rank,tp) ->
                         let uu____4831 =
                           FStar_All.pipe_right
                             ...
                             (fun _0_39  ->
                                FStar_TypeChecker_Common.TProb _0_39) in
                         (rank, uu____4831))))
      | FStar_TypeChecker_Common.CProb cp ->
          let uu____4840 =
            FStar_All.pipe_right
              (let uu___140_4843 = cp in
               ...
               }) (fun _0_40  -> FStar_TypeChecker_Common.CProb _0_40) in
                     ...
                     (fun u  ->
                        ...
                        | (k,uu____5035) ->
                            (match k with
                             ...
                             | uu____5040 -> false)))
            | uu____5041 -> occurs_univ v1 (FStar_Syntax_Syntax.U_max [u]) in
          let try_umax_components u1 u2 msg =
            ...
            | (FStar_Syntax_Syntax.U_max us1,FStar_Syntax_Syntax.U_max us2)
                ...
                then
                  ...
                  (let uu____5093 =
                     let uu____5094 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____5095 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2
          ...
          | (FStar_Syntax_Syntax.U_unif v1,u)
            |(u,FStar_Syntax_Syntax.U_unif v1) ->
              ...
              then
                ...
                (let uu____5159 = extend_solution pid_orig [UNIV (v1, u)] wl in
                 USolved uu____5159)
      ...
      (match uu____5265 with
       | (bs2,mk_cod2) ->
           let curry n bs mk_cod =
             ...
             | (bs,rest) -> let uu____5326 = mk_cod rest in (bs, uu____5326) in
                ...
                then
                  ...
                  if
                    ((Prims.op_Negation probs.defer_ok) &&
                      ...
                      && (rank <= refine_flex)
                  then
                    (let uu____5533 = solve_rigid_flex_meet env tp probs in
                  ...
                  FStar_All.pipe_right probs.wl_deferred
                    (FStar_List.partition
                       (fun uu____5580  ->
                          ...
                          | (c,uu____5585,uu____5586) -> c < probs.ctr)) in
        ...
        fun t2  ->
          fun wl  ->
            let rec aux wl us1 us2 =
              ...
              | ([],[]) -> USolved wl
              | (u1::us1,u2::us2) ->
                  let uu____5687 = solve_universe_eq (p_pid orig) wl u1 u2 in
                   ...
                   (match mr with
                    ...
                    | HeadMatch  ->
                        let uu____5831 =
                          match ts with
                          | Some (t1,t2) ->
                              let uu____5840 = FStar_Syntax_Subst.compress t1 in
                              let uu____5841 = FStar_Syntax_Subst.compress t2 in
                              (uu____5840, uu____5841)
                          | None  ->
                              let uu____5844 = FStar_Syntax_Subst.compress t1 in
                              let uu____5845 = FStar_Syntax_Subst.compress t2 in
                              (uu____5844, uu____5845) in
                              ...
                              | (uu____5932,FStar_Syntax_Syntax.Tm_refine
                                 (x,uu____5934)) ->
                                  let uu____5939 =
                                    let uu____5943 =
                                      let uu____5945 =
                                        eq_prob x.FStar_Syntax_Syntax.sort t1 in
                                      [uu____5945] in
                                    (t1, uu____5943) in
                                  Some uu____5939
                              | (FStar_Syntax_Syntax.Tm_refine
                                 (x,uu____5951),uu____5952) ->
                                  let uu____5957 =
                                    let uu____5961 =
                                      let uu____5963 =
                                        eq_prob x.FStar_Syntax_Syntax.sort t2 in
                                      [uu____5963] in
                                    (t2, uu____5961) in
                                  Some uu____5957
                              | uu____5968 ->
                                  ...
                                  let uu___143_6214 = wl in
                                  {
                                    attempting =
                                      ((FStar_TypeChecker_Common.TProb
                                          eq_prob) :: sub_probs);
                                    wl_deferred = (uu___143_6214.wl_deferred);
             ...
             (match uu____6265 with
              | (ok,head_match,partial_match,fallback,failed_match) ->
                  ...
                  let base_types_match t1 t2 =
                    ...
                    | (h1,args1) ->
                        let uu____6324 = FStar_Syntax_Util.head_and_args t2 in
                                   ...
                                   then
                                     let wl' =
                                       let uu___146_6824 = wl in
                                       {
                                         ...
                                         defer_ok = (uu___146_6824.defer_ok);
                    ...
                    (match uu____6960 with
                     | FStar_Util.Inl (sub_probs,phi) ->
                         let phi =
                           ...
                           FStar_Syntax_Util.mk_conj uu____6978 uu____6981 in
                         ((let uu____6987 =
                             FStar_All.pipe_left
                               (FStar_TypeChecker_Env.debug env)
                               (FStar_Options.Other "Rel") in
  ...
  fun env  ->
    fun problem  ->
      fun wl  ->
              ...
              (match (m, o) with
               | (MisMatch uu____7076,uu____7077) ->
                   let may_relate head =
                     ...
                     | uu____7099 -> false in
                   let uu____7100 =
                     ((may_relate head1) || (may_relate head2)) && wl.smt_ok in
                   if uu____7100
                   then
                     let guard =
                       if
                         ...
                         (let has_type_guard t1 t2 =
                            ...
                            | None  ->
                                ...
                                let uu____7120 =
                                  ...
                                  FStar_Syntax_Util.mk_has_type t1 uu____7121
                                    t2 in
                                FStar_Syntax_Util.mk_forall x uu____7120 in
                          if
                            problem.FStar_TypeChecker_Common.relation =
                              FStar_TypeChecker_Common.SUB
                          then has_type_guard t1 t2
                          else has_type_guard t2 t1) in
                     let uu____7125 = solve_prob orig (Some guard) [] wl in
               ...
               | (uu____7138,None ) ->
                   ((let uu____7145 =
                     ...
                     if uu____7145
                     then
                       let uu____7146 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____7147 = FStar_Syntax_Print.tag_of_term t1 in
                       let uu____7148 = FStar_Syntax_Print.term_to_string t2 in
                       let uu____7149 = FStar_Syntax_Print.tag_of_term t2 in
                       FStar_Util.print4
                    ...
                    (let uu____7151 = FStar_Syntax_Util.head_and_args t1 in
                     ...
                     | (head1,args1) ->
                         let uu____7177 = FStar_Syntax_Util.head_and_args t2 in
                          ...
                          | (head2,args2) ->
                              ...
                              then
                                let uu____7217 =
                                  ...
                                  let uu____7219 = args_to_string args1 in
                                  let uu____7220 =
                                    FStar_Syntax_Print.term_to_string head2 in
                                  let uu____7221 = args_to_string args2 in
                                  FStar_Util.format4
                                ...
                                (let uu____7223 =
                                   (nargs = (Prims.parse_int "0")) ||
                                     (let uu____7226 =
                                      ...
                                      uu____7226 = FStar_Syntax_Util.Equal) in
                                 if uu____7223
                                 then
                                   let uu____7227 =
               ...
               | (sub_probs,gs_xs,formula) ->
                   ...
                   ((let uu____7517 =
                     ...
                     then
                       ...
                       let uu____7519 = FStar_Syntax_Print.comp_to_string c in
                       let uu____7520 = FStar_Syntax_Print.term_to_string im in
                       let uu____7521 = FStar_Syntax_Print.tag_of_term im in
                       let uu____7522 =
                         let uu____7523 =
              ...
              (match uu____7631 with
               | (pi,uu____7634) ->
                   ...
                   (match uu____7639 with
                    | (xi,uu____7646) ->
                        let rec gs k =
                          let uu____7655 = FStar_Syntax_Util.arrow_formals k in
                                              ...
                                              let uu____7752 =
                                                let uu____7754 =
                                                  FStar_Syntax_Syntax.as_arg
                                                    gi_ps in
                                                uu____7754 :: gi_ps' in
                                              (uu____7749, uu____7752))) in
                              aux [] bs in
                        let uu____7757 =
                          let uu____7758 = matches pi in
                          FStar_All.pipe_left Prims.op_Negation uu____7758 in
                        if uu____7757
                        then None
                        else
                          (let uu____7761 = gs xi.FStar_Syntax_Syntax.sort in
                           ...
                           | (g_xs,uu____7768) ->
                               ...
                               let proj =
                                 ...
                                 let uu____7780 =
                                   let uu____7787 =
                                     FStar_All.pipe_right
                                       (FStar_Syntax_Util.lcomp_of_comp c)
                                       (fun _0_48  -> FStar_Util.Inl _0_48) in
                                   FStar_All.pipe_right uu____7787
                                     (fun _0_49  -> Some _0_49) in
                                     ...
                                     let uu____7831 =
                                       FStar_List.map
                                         (fun uu____7837  ->
                                            ...
                                            | (uu____7842,uu____7843,y) -> y)
                                         qs in
                                     FStar_All.pipe_left h uu____7831 in
                                   mk_problem (p_scope orig) orig uu____7821
                                     (p_rel orig) uu____7828 None
                                     "projection" in
                                 FStar_All.pipe_left
                                   (fun _0_50  ->
                               ...
                               ((let uu____7853 =
                                 ...
                                 then
                                   ...
                                   let uu____7855 = prob_to_string env sub in
                                   FStar_Util.print2
                                     "Projecting %s\n\tsubprob=%s\n"
                    ...
                    then
                      ...
                      (let k_uv =
                       ...
                       let rec elim k args =
                         let uu____8043 =
                           let uu____8047 =
                             let uu____8048 = FStar_Syntax_Subst.compress k in
                                           ...
                                           let uu____8286 =
                                             elim
                                               (FStar_Syntax_Util.comp_result
                                                  c) rest in
                                           FStar_Util.bind_opt uu____8286
                                             (fun uu____8297  ->
                         ...
                         | uu____8376 ->
                             let uu____8380 =
                               ...
                               FStar_Util.format3
                                 ...
                                 uu____8381 uu____8385 uu____8386 in
                             failwith uu____8380 in
                     ...
                     | uu____8599 ->
                         ...
                         then true
                           ...
                           ((let uu____8605 =
                             ...
                             if uu____8605
                             then
                               let uu____8606 = names_to_string fvs_hd in
                    ...
                    | (occurs_ok,msg) ->
                        ...
                        then
                          let uu____8665 =
                            ...
                            Prims.strcat "occurs-check failed: " uu____8666 in
                              ...
                              then
                                ...
                                ((let uu____8674 =
                                  ...
                                  then
                                    ...
                                    let uu____8676 = names_to_string fvs1 in
                                    let uu____8677 = names_to_string fvs2 in
                                    FStar_Util.print3
                                 ...
                                 (let sol =
                                    ...
                                    | [] -> t2
                                    | uu____8682 ->
                                        let uu____8683 = sn_binders env vars in
                                        u_abs k_uv uu____8683 t2 in
                                  let wl =
                                ...
                                then
                                  ((let uu____8694 =
                                    ...
                                    then
                                      let uu____8695 =
                                        FStar_Syntax_Print.term_to_string t1 in
                                      let uu____8696 = names_to_string fvs1 in
                                      let uu____8697 = names_to_string fvs2 in
                                      FStar_Util.print3
                                        "Pattern %s with fvars=%s failed fvar check: %s ... imitating\n"
                                        uu____8695 uu____8696 uu____8697
                                    else ());
                                   (let uu____8699 = subterms args_lhs in
                                    imitate_or_project
                                      (FStar_List.length args_lhs) uu____8699
                                      (- (Prims.parse_int "1"))))
                                else
                                  giveup env
                    ...
                    | (all_formals,uu____8802) ->
                        let rec aux pat_args pattern_vars pattern_var_set
                          ...
                          | ([],[]) ->
                              ...
                              let kk =
                                let uu____8909 = FStar_Syntax_Util.type_u () in
                                match uu____8909 with
                                | (t,uu____8913) ->
                                    let uu____8914 =
                                      new_uvar t.FStar_Syntax_Syntax.pos
                                        pattern_vars t in
                                    Prims.fst uu____8914 in
                              let uu____8917 =
                                new_uvar t.FStar_Syntax_Syntax.pos
                                  pattern_vars kk in
                          ...
                          | (formal::formals,hd::tl) ->
                              let uu____9040 = pat_var_opt env pat_args hd in
                                      ...
                                      then
                                        ...
                                        (let uu____9084 =
                                         ...
                                         aux (y :: pat_args) (formal ::
                                           pattern_vars) uu____9084 formals
                                           tl)))
                          | uu____9090 -> failwith "Impossible" in
                        let uu____9101 = FStar_Syntax_Syntax.new_bv_set () in
                        aux [] [] uu____9101 all_formals args) in
                     ...
                     (let xs = sn_binders env xs in
                      ...
                      (let subst_k k xs args =
                         ...
                         then
                           ...
                           if args_len < xs_len
                           then
                             (let uu____9378 = FStar_Util.first_N args_len xs in
                              ...
                              | (xs,xs_rest) ->
                                  ...
                                  let uu____9411 =
                                    FStar_Syntax_Util.subst_of_list xs args in
                                  FStar_Syntax_Subst.subst uu____9411 k)
                           else
                             (let uu____9414 =
                                let uu____9415 =
                                  FStar_Syntax_Print.term_to_string k in
                                ...
                                FStar_Util.format3
                                  ...
                                  uu____9415 uu____9416 uu____9417 in
                              failwith uu____9414) in
                       let uu____9418 =
                         let uu____9424 =
                           let uu____9432 =
                             FStar_TypeChecker_Normalize.normalize
                         ...
                         | (bs,k1') ->
                             let uu____9450 =
                               ...
                               FStar_Syntax_Util.arrow_formals uu____9458 in
                                  ...
                                  (match uu____9484 with
                                   ...
                                   | uu____9510 ->
                                       ...
                                       (match uu____9513 with
                                        | (t,uu____9522) ->
                                            let uu____9523 = new_uvar r zs t in
                       ...
                       | (k_u',sub_probs) ->
                           let uu____9548 =
                             let uu____9556 =
                               ...
                               FStar_All.pipe_left Prims.fst uu____9557 in
                             let uu____9562 =
                               let uu____9565 =
             ...
             let solve_one_pat uu____9673 uu____9674 =
               ...
               | ((t1,u1,k1,xs),(t2,u2,k2,args2)) ->
                   ((let uu____9778 =
                     ...
                     if uu____9778
                     then
                       let uu____9779 = FStar_Syntax_Print.term_to_string t1 in
                       let uu____9780 = FStar_Syntax_Print.term_to_string t2 in
                       FStar_Util.print2
                    ...
                    (let uu____9782 = FStar_Unionfind.equivalent u1 u2 in
                     ...
                     then
                       ...
                       (let t2 = sn env t2 in
                        ...
                        let uu____9827 = occurs_check env wl (u1, k1) t2 in
                             ...
                             (let uu____9931 =
                              ...
                              | (sol,uu____9938) ->
                                  ...
                                  ((let uu____9941 =
                                    ...
                                    if uu____9941
                                    then
                                      let uu____9942 = uvi_to_string env sol in
                                      FStar_Util.print1
        ...
        if uu____9949
        then
          let uu____9950 = solve_prob orig None [] wl in solve env uu____9950
        else
                  ...
                  (bs1,c1),FStar_Syntax_Syntax.Tm_arrow (bs2,c2)) ->
                   let mk_c c uu___124_10005 =
                     ...
                     | bs ->
                         ...
                         FStar_Syntax_Syntax.mk_Total uu____10019 in
                   let uu____10033 =
                               ...
                               fun subst  ->
                                 let uu____10320 =
                                   ...
                                   mk_problem scope orig uu____10323
                                     problem.FStar_TypeChecker_Common.relation
                                     uu____10324 None "lambda co-domain" in
                                 FStar_All.pipe_left
                                   (fun _0_58  ->
                   ...
                   (match uu____10382 with
                    ...
                    | (FStar_Util.Inl t_abs,FStar_Util.Inr not_abs)
                      |(FStar_Util.Inr not_abs,FStar_Util.Inl t_abs) ->
                        ...
                        if uu____10462
                        then
                          let uu____10463 = destruct_flex_pattern env not_abs in
                          solve_t_flex_rigid true orig uu____10463 t_abs wl
                        else
                          giveup env
                               ...
                               let guard =
                                 let uu____10543 =
                                   FStar_All.pipe_right (p_guard base_prob)
                                     Prims.fst in
                                 FStar_Syntax_Util.mk_conj uu____10543 impl in
                               let wl = solve_prob orig (Some guard) [] wl in
                                ...
                                | Success uu____10565 ->
                                    let guard =
                                      ...
                                      let uu____10572 =
                                        ...
                                        FStar_All.pipe_right uu____10573
                                          (guard_on_element problem x1) in
                                      FStar_Syntax_Util.mk_conj uu____10569
                                        uu____10572 in
                                    let wl =
                                    ...
                                    let wl =
                                      let uu___155_10580 = wl in
                                      {
                                        ...
                                        defer_ok = (uu___155_10580.defer_ok);
                                        smt_ok = (uu___155_10580.smt_ok);
                   ...
                   then
                     ...
                     (let new_rel = problem.FStar_TypeChecker_Common.relation in
                      let uu____10718 =
                        ...
                        FStar_All.pipe_left Prims.op_Negation uu____10719 in
                      if uu____10718
                      then
                        let uu____10720 =
                          FStar_All.pipe_left
                        ...
                        let uu____10724 = destruct_flex_pattern env t1 in
                        solve_t_flex_rigid false uu____10720 uu____10724 t2
                          wl
                      else
                        (let uu____10729 = base_and_refinement env wl t2 in
                         ...
                         | (t_base,ref_opt) ->
                             (match ref_opt with
                              | None  ->
                                  ...
                                  solve_t_flex_rigid false uu____10759
                                    uu____10763 t_base wl
                              | Some (y,phi) ->
                                  let y' =
                                  ...
                                  let guard =
                                    let uu____10789 =
                                      FStar_All.pipe_right
                                        (p_guard base_prob) Prims.fst in
                                    FStar_Syntax_Util.mk_conj uu____10789
                                      impl in
                                  let wl = solve_prob orig (Some guard) [] wl in
                                  solve env (attempt [base_prob] wl))))
               | (_,FStar_Syntax_Syntax.Tm_uvar _)
                 |(_,FStar_Syntax_Syntax.Tm_app
                   ...
                   then
                     ...
                     (let uu____10811 = base_and_refinement env wl t1 in
               ...
               | (FStar_Syntax_Syntax.Tm_match _,_)
                 |(FStar_Syntax_Syntax.Tm_uinst _,_)
                  |(FStar_Syntax_Syntax.Tm_name _,_)
                   ...
                   ->
                   let head1 =
                     let uu____10915 = FStar_Syntax_Util.head_and_args t1 in
                     FStar_All.pipe_right uu____10915 Prims.fst in
                   let head2 =
                     let uu____10946 = FStar_Syntax_Util.head_and_args t2 in
                   ...
                   then
                     ...
                     (if uu____10983
                      then
                        let guard =
                          let uu____10992 =
                            let uu____10993 = FStar_Syntax_Util.eq_tm t1 t2 in
                            uu____10993 = FStar_Syntax_Util.Equal in
                          if uu____10992
                          then None
                          else
                            (let uu____11000 =
                               FStar_Syntax_Util.mk_eq
                                 ...
                                 FStar_Syntax_Syntax.tun t1 t2 in
                             FStar_All.pipe_left (fun _0_64  -> Some _0_64)
                               uu____11000) in
                        let uu____11010 = solve_prob orig guard [] wl in
               ...
               | (FStar_Syntax_Syntax.Tm_let _,_)
                 |(FStar_Syntax_Syntax.Tm_meta _,_)
                  |(FStar_Syntax_Syntax.Tm_delayed _,_)
                   ...
                   ->
                   let uu____11073 =
                     let uu____11074 = FStar_Syntax_Print.tag_of_term t1 in
                     let uu____11075 = FStar_Syntax_Print.tag_of_term t2 in
                     FStar_Util.format2 "Impossible: %s and %s" uu____11074
                       uu____11075 in
               ...
               | uu____11269 ->
                   let uu____11282 =
                     ...
                     FStar_Util.format2
                       ...
                       uu____11283 uu____11284 in
                   failwith uu____11282 in
             match uu____11200 with
             | (wpc1,wpc2) ->
                 let uu____11301 = FStar_Util.physical_equality wpc1 wpc2 in
                 if uu____11301
                 then
                   let uu____11304 =
                   ...
                   (let c2_decl =
                          ...
                          ((let uu____11312 =
                           ...
                           (let uu____11314 =
                              let uu____11317 =
                                ...
                                FStar_Syntax_Syntax.Tm_app uu____11318 in
                    ...
                    let base_prob =
                      ...
                      FStar_All.pipe_left
                        (fun _0_66  -> FStar_TypeChecker_Common.TProb _0_66)
                        uu____11385 in
                    let wl =
                      let uu____11391 =
                        let uu____11393 =
                                ...
                                then
                                  ...
                                  (let uu____11538 =
                                     ...
                                     FStar_Util.format2
                                       ...
                                       uu____11539 uu____11540 in
                                   giveup env uu____11538 orig)
      ...
      FStar_All.pipe_right g.FStar_TypeChecker_Env.implicits
        (FStar_List.map
           (fun uu____11565  ->
              ...
              | (uu____11576,uu____11577,u,uu____11579,uu____11580,uu____11581)
                  -> FStar_Syntax_Print.uvar_to_string u)) in
    FStar_All.pipe_right uu____11545 (FStar_String.concat ", ")
let ineqs_to_string:
  ...
  fun ineqs  ->
    let vars =
      ...
      FStar_All.pipe_right uu____11610 (FStar_String.concat ", ") in
    let ineqs =
      let uu____11620 =
        FStar_All.pipe_right (Prims.snd ineqs)
          (FStar_List.map
             (fun uu____11632  ->
                ...
                | (u1,u2) ->
                    let uu____11637 = FStar_Syntax_Print.univ_to_string u1 in
                    let uu____11638 = FStar_Syntax_Print.univ_to_string u2 in
                    FStar_Util.format2 "%s < %s" uu____11637 uu____11638)) in
      FStar_All.pipe_right uu____11620 (FStar_String.concat ", ") in
...
let guard_to_string:
  ...
  fun env  ->
    fun g  ->
      ...
      with
      | (FStar_TypeChecker_Common.Trivial ,[],(uu____11650,[])) -> "{}"
      | uu____11663 ->
          let form =
            ...
            let uu____11676 =
              FStar_List.map
                (fun uu____11680  ->
                   ...
                   | (uu____11683,x) -> prob_to_string env x)
                g.FStar_TypeChecker_Env.deferred in
            FStar_All.pipe_right uu____11676 (FStar_String.concat ",\n") in
          let imps = print_pending_implicits g in
          let uu____11687 =
            ineqs_to_string g.FStar_TypeChecker_Env.univ_ineqs in
          FStar_Util.format4
            "\n\t{guard_f=%s;\n\t deferred={\n%s};\n\t univ_ineqs={%s};\n\t implicits={%s}}\n"
            form carry uu____11687 imps
...
let is_trivial: FStar_TypeChecker_Env.guard_t -> Prims.bool =
  fun g  ->
    ...
    | { FStar_TypeChecker_Env.guard_f = FStar_TypeChecker_Common.Trivial ;
        FStar_TypeChecker_Env.deferred = [];
        FStar_TypeChecker_Env.univ_ineqs = uu____11707;
        FStar_TypeChecker_Env.implicits = uu____11708;_} -> true
    | uu____11722 -> false
    ...
    fun g  ->
      ...
      | Some g ->
          let f =
            ...
            | uu____11749 -> failwith "impossible" in
          let uu____11750 =
            let uu___167_11751 = g in
            let uu____11752 =
              let uu____11753 =
                let uu____11754 =
                  let uu____11758 = FStar_Syntax_Syntax.mk_binder x in
                  [uu____11758] in
                let uu____11759 =
                  let uu____11766 =
                    let uu____11772 =
                    ...
                    FStar_All.pipe_right uu____11772
                      (fun _0_68  -> FStar_Util.Inl _0_68) in
                  Some uu____11766 in
                FStar_Syntax_Util.abs uu____11754 f uu____11759 in
              FStar_All.pipe_left
                (fun _0_69  -> FStar_TypeChecker_Common.NonTrivial _0_69)
                uu____11753 in
            {
              FStar_TypeChecker_Env.guard_f = uu____11752;
              FStar_TypeChecker_Env.deferred =
                (uu___167_11751.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___167_11751.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___167_11751.FStar_TypeChecker_Env.implicits)
            } in
          Some uu____11750
let apply_guard:
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ...
          let uu____11795 =
            let uu____11796 =
              let uu____11797 =
                let uu____11800 =
                  let uu____11801 =
                    let uu____11811 =
                      let uu____11813 = FStar_Syntax_Syntax.as_arg e in
                      [uu____11813] in
                    (f, uu____11811) in
                  FStar_Syntax_Syntax.Tm_app uu____11801 in
                FStar_Syntax_Syntax.mk uu____11800 in
              uu____11797
            ...
            FStar_All.pipe_left
              ...
              uu____11796 in
          {
            FStar_TypeChecker_Env.guard_f = uu____11795;
            FStar_TypeChecker_Env.deferred =
              (uu___168_11794.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___168_11794.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___168_11794.FStar_TypeChecker_Env.implicits)
          }
let trivial: FStar_TypeChecker_Common.guard_formula -> Prims.unit =
  fun t  ->
    match t with
    | FStar_TypeChecker_Common.Trivial  -> ()
    | FStar_TypeChecker_Common.NonTrivial uu____11826 ->
        failwith "impossible"
let conj_guard_f:
    ...
    fun g2  ->
      ...
      | (FStar_TypeChecker_Common.NonTrivial
         f1,FStar_TypeChecker_Common.NonTrivial f2) ->
          let uu____11836 = FStar_Syntax_Util.mk_conj f1 f2 in
          FStar_TypeChecker_Common.NonTrivial uu____11836
let check_trivial:
  (FStar_Syntax_Syntax.term',FStar_Syntax_Syntax.term')
  ...
  fun t  ->
    ...
    | FStar_Syntax_Syntax.Tm_fvar tc when
        ...
        FStar_TypeChecker_Common.Trivial
    | uu____11845 -> FStar_TypeChecker_Common.NonTrivial t
let imp_guard_f:
  FStar_TypeChecker_Common.guard_formula ->
    FStar_TypeChecker_Common.guard_formula ->
      FStar_TypeChecker_Common.guard_formula
  ...
  fun f  ->
    fun g1  ->
      fun g2  ->
        ...
        {
          FStar_TypeChecker_Env.guard_f = uu____11876;
          FStar_TypeChecker_Env.deferred =
...
let close_guard:
  ...
  fun binders  ->
    fun g  ->
      ...
      | FStar_TypeChecker_Common.Trivial  -> g
      | FStar_TypeChecker_Common.NonTrivial f ->
          let uu___169_11914 = g in
          let uu____11915 =
            let uu____11916 = FStar_Syntax_Util.close_forall binders f in
            FStar_All.pipe_right uu____11916
              (fun _0_71  -> FStar_TypeChecker_Common.NonTrivial _0_71) in
          {
            FStar_TypeChecker_Env.guard_f = uu____11915;
            FStar_TypeChecker_Env.deferred =
              (uu___169_11914.FStar_TypeChecker_Env.deferred);
            FStar_TypeChecker_Env.univ_ineqs =
              (uu___169_11914.FStar_TypeChecker_Env.univ_ineqs);
            FStar_TypeChecker_Env.implicits =
              (uu___169_11914.FStar_TypeChecker_Env.implicits)
          }
let new_t_problem env lhs rel rhs elt loc =
  let reason =
    ...
    if uu____11954
    then
      let uu____11955 = FStar_TypeChecker_Normalize.term_to_string env lhs in
      let uu____11956 = FStar_TypeChecker_Normalize.term_to_string env rhs in
      FStar_Util.format3 "Top-level:\n%s\n\t%s\n%s" uu____11955
        (rel_to_string rel) uu____11956
    else "TOP" in
    ...
    fun t1  ->
      fun rel  ->
        fun t2  ->
          let x =
            let uu____11976 =
              let uu____11978 = FStar_TypeChecker_Env.get_range env in
              FStar_All.pipe_left (fun _0_72  -> Some _0_72) uu____11978 in
            FStar_Syntax_Syntax.new_bv uu____11976 t1 in
          let env = FStar_TypeChecker_Env.push_bv env x in
          let p =
            let uu____11984 =
              let uu____11986 = FStar_Syntax_Syntax.bv_to_name x in
              FStar_All.pipe_left (fun _0_73  -> Some _0_73) uu____11986 in
            let uu____11988 = FStar_TypeChecker_Env.get_range env in
            new_t_problem env t1 rel t2 uu____11984 uu____11988 in
...
let solve_and_commit:
  ...
  fun env  ->
    fun probs  ->
      fun err  ->
        let probs =
          let uu____12011 = FStar_Options.eager_inference () in
          if uu____12011
          then
            let uu___170_12012 = probs in
            {
              attempting = (uu___170_12012.attempting);
              wl_deferred = (uu___170_12012.wl_deferred);
              ctr = (uu___170_12012.ctr);
              defer_ok = false;
              smt_ok = (uu___170_12012.smt_ok);
              tcenv = (uu___170_12012.tcenv)
            }
          else probs in
        let tx = FStar_Unionfind.new_transaction () in
        ...
        | Failed (d,s) ->
            (FStar_Unionfind.rollback tx;
             (let uu____12023 =
              ...
              if uu____12023
              then
                let uu____12024 = explain env d s in
                FStar_All.pipe_left FStar_Util.print_string uu____12024
              else ());
             err (d, s))
let simplify_guard:
  FStar_TypeChecker_Env.env ->
    ...
    fun g  ->
      ...
      | FStar_TypeChecker_Common.NonTrivial f ->
          ((let uu____12034 =
            ...
            if uu____12034
            then
              let uu____12035 = FStar_Syntax_Print.term_to_string f in
           ...
           (let f =
            ...
            (let uu____12039 =
             ...
             if uu____12039
             then
               let uu____12040 = FStar_Syntax_Print.term_to_string f in
               FStar_Util.print1 "Simplified guard to %s\n" uu____12040
             else ());
            (let f =
               let uu____12043 =
                 let uu____12044 = FStar_Syntax_Util.unmeta f in
               ...
               | FStar_Syntax_Syntax.Tm_fvar fv when
                   ...
                   -> FStar_TypeChecker_Common.Trivial
               | uu____12048 -> FStar_TypeChecker_Common.NonTrivial f in
             let uu___171_12049 = g in
             {
               FStar_TypeChecker_Env.guard_f = f;
               FStar_TypeChecker_Env.deferred =
                 (uu___171_12049.FStar_TypeChecker_Env.deferred);
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___171_12049.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___171_12049.FStar_TypeChecker_Env.implicits)
             })))
let with_guard:
  FStar_TypeChecker_Env.env ->
    FStar_TypeChecker_Common.prob ->
            ...
            let uu____12064 =
              let uu____12065 =
                let uu____12066 =
                  let uu____12067 =
                    FStar_All.pipe_right (p_guard prob) Prims.fst in
                  FStar_All.pipe_right uu____12067
                    (fun _0_74  -> FStar_TypeChecker_Common.NonTrivial _0_74) in
                {
                  FStar_TypeChecker_Env.guard_f = uu____12066;
                  FStar_TypeChecker_Env.deferred = d;
                  FStar_TypeChecker_Env.univ_ineqs = ([], []);
                  FStar_TypeChecker_Env.implicits = []
                } in
              simplify_guard env uu____12065 in
            FStar_All.pipe_left (fun _0_75  -> Some _0_75) uu____12064
let try_teq:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
    ...
    fun t1  ->
      fun t2  ->
        (let uu____12091 =
         ...
         if uu____12091
         then
           let uu____12092 = FStar_Syntax_Print.term_to_string t1 in
           let uu____12093 = FStar_Syntax_Print.term_to_string t2 in
           FStar_Util.print2 "try_teq of %s and %s\n" uu____12092 uu____12093
         else ());
        (let prob =
           let uu____12096 =
             let uu____12099 = FStar_TypeChecker_Env.get_range env in
             new_t_problem env t1 FStar_TypeChecker_Common.EQ t2 None
               uu____12099 in
           FStar_All.pipe_left
             (fun _0_76  -> FStar_TypeChecker_Common.TProb _0_76) uu____12096 in
         let g =
           let uu____12104 =
             let uu____12106 = singleton env prob in
             solve_and_commit env uu____12106 (fun uu____12107  -> None) in
           FStar_All.pipe_left (with_guard env prob) uu____12104 in
         g)
let teq:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.typ ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____12121 = try_teq env t1 t2 in
        ...
        | None  ->
            let uu____12123 =
              let uu____12124 =
                ...
                let uu____12128 = FStar_TypeChecker_Env.get_range env in
                (uu____12127, uu____12128) in
              FStar_Errors.Error uu____12124 in
            Prims.raise uu____12123
        | Some g ->
            ((let uu____12131 =
                FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                  (FStar_Options.Other "Rel") in
              if uu____12131
              then
                let uu____12132 = FStar_Syntax_Print.term_to_string t1 in
                let uu____12133 = FStar_Syntax_Print.term_to_string t2 in
                let uu____12134 = guard_to_string env g in
                FStar_Util.print3
                  "teq of %s and %s succeeded with guard %s\n" uu____12132
                  uu____12133 uu____12134
              else ());
             g)
let try_subtype':
  FStar_TypeChecker_Env.env ->
        ...
        fun smt_ok  ->
          ...
          (let uu____12154 =
           ...
           | (prob,x) ->
               let g =
                 let uu____12162 =
                   let uu____12164 = singleton' env prob smt_ok in
                   solve_and_commit env uu____12164
                     (fun uu____12165  -> None) in
                 FStar_All.pipe_left (with_guard env prob) uu____12162 in
               ((let uu____12171 =
                   (FStar_All.pipe_left (FStar_TypeChecker_Env.debug env)
                      (FStar_Options.Other "Rel"))
                 ...
                 then
                   ...
                   let uu____12173 =
                     FStar_TypeChecker_Normalize.term_to_string env t2 in
                   let uu____12174 =
                     let uu____12175 = FStar_Util.must g in
                     guard_to_string env uu____12175 in
                   FStar_Util.print3
                     "try_subtype succeeded: %s <: %s\n\tguard is %s\n"
                     uu____12172 uu____12173 uu____12174
                 else ());
                abstract_guard x g))
let try_subtype:
  FStar_TypeChecker_Env.env ->
...
let subtype_fail:
  ...
  fun env  ->
    fun e  ->
      fun t1  ->
        fun t2  ->
          let uu____12199 = FStar_TypeChecker_Env.get_range env in
          let uu____12200 =
            FStar_TypeChecker_Err.basic_type_error env (Some e) t2 t1 in
          FStar_Errors.report uu____12199 uu____12200
let sub_comp:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
    ...
    fun c1  ->
      fun c2  ->
        (let uu____12212 =
         ...
         if uu____12212
         then
           let uu____12213 = FStar_Syntax_Print.comp_to_string c1 in
           let uu____12214 = FStar_Syntax_Print.comp_to_string c2 in
        ...
        (let rel =
         ...
         let prob =
           let uu____12219 =
             let uu____12222 = FStar_TypeChecker_Env.get_range env in
             new_problem env c1 rel c2 None uu____12222 "sub_comp" in
           FStar_All.pipe_left
             (fun _0_77  -> FStar_TypeChecker_Common.CProb _0_77) uu____12219 in
         let uu____12225 =
           let uu____12227 = singleton env prob in
           solve_and_commit env uu____12227 (fun uu____12228  -> None) in
         FStar_All.pipe_left (with_guard env prob) uu____12225)
        ...
        | (variables,ineqs) ->
            let fail u1 u2 =
              ...
              (let uu____12272 =
                 let uu____12273 =
                   let uu____12276 =
                     let uu____12277 = FStar_Syntax_Print.univ_to_string u1 in
                     let uu____12278 = FStar_Syntax_Print.univ_to_string u2 in
                     FStar_Util.format2 "Universe %s and %s are incompatible"
                       uu____12277 uu____12278 in
                   let uu____12279 = FStar_TypeChecker_Env.get_range env in
                   (uu____12276, uu____12279) in
                 FStar_Errors.Error uu____12273 in
               Prims.raise uu____12272) in
            let equiv v v' =
              let uu____12287 =
                let uu____12290 = FStar_Syntax_Subst.compress_univ v in
                let uu____12291 = FStar_Syntax_Subst.compress_univ v' in
                (uu____12290, uu____12291) in
            ...
            let sols =
              FStar_All.pipe_right variables
                (FStar_List.collect
                   (fun v  ->
                      let uu____12313 = FStar_Syntax_Subst.compress_univ v in
                      match uu____12313 with
                      | FStar_Syntax_Syntax.U_unif uu____12317 ->
                            ...
                            FStar_All.pipe_right ineqs
                              (FStar_List.collect
                                 (fun uu____12328  ->
                                    ...
                                    | (u,v') ->
                                        let uu____12334 = equiv v v' in
                                        if uu____12334
                                        then
                                          let uu____12336 =
                                            FStar_All.pipe_right variables
                                              (FStar_Util.for_some (equiv u)) in
                                          (if uu____12336 then [] else [u])
                                        else [])) in
                          let lb =
            ...
            let uu____12349 =
              let wl =
                let uu___172_12352 = empty_worklist env in
                {
                  attempting = (uu___172_12352.attempting);
                  wl_deferred = (uu___172_12352.wl_deferred);
                  ctr = (uu___172_12352.ctr);
                  defer_ok = false;
                  smt_ok = (uu___172_12352.smt_ok);
                  tcenv = (uu___172_12352.tcenv)
                } in
                   ...
                   (fun uu____12359  ->
                      ...
                      | (lb,v) ->
                          ...
                          (match uu____12364 with
                           | USolved wl -> ()
                           | uu____12366 -> fail lb v))) in
            let rec check_ineq uu____12372 =
              ...
              | (u,v) ->
                  ...
                  (match (u, v) with
                   | (FStar_Syntax_Syntax.U_zero ,uu____12379) -> true
                   ...
                   | (FStar_Syntax_Syntax.U_max us,uu____12395) ->
                       FStar_All.pipe_right us
                         (FStar_Util.for_all (fun u  -> check_ineq (u, v)))
                   | (uu____12399,FStar_Syntax_Syntax.U_max vs) ->
              ...
              FStar_All.pipe_right ineqs
                (FStar_Util.for_all
                   (fun uu____12413  ->
                      ...
                      | (u,v) ->
                          let uu____12418 = check_ineq (u, v) in
                          if uu____12418
                          then true
                          else
                            ((let uu____12421 =
                              ...
                              then
                                ...
                                FStar_Util.print2 "%s </= %s" uu____12422
                                  uu____12423
                              else ());
                             false))) in
            if uu____12407
            then ()
              ...
              ((let uu____12427 =
                ...
                if uu____12427
                then
                  ((let uu____12429 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
                      "Partially solved inequality constraints are: %s\n"
                      uu____12429);
                   FStar_Unionfind.rollback tx;
                   (let uu____12435 = ineqs_to_string (variables, ineqs) in
                    FStar_Util.print1
               ...
               (let uu____12441 =
                  let uu____12442 =
                    let uu____12445 = FStar_TypeChecker_Env.get_range env in
                    ("Failed to solve universe inequalities for inductives",
                      uu____12445) in
                  FStar_Errors.Error uu____12442 in
                Prims.raise uu____12441))
let solve_universe_inequalities:
  FStar_TypeChecker_Env.env ->
    (FStar_Syntax_Syntax.universe Prims.list* (FStar_Syntax_Syntax.universe*
  ...
  fun env  ->
    fun g  ->
      ...
      (let uu____12488 =
       ...
       if uu____12488
       then
         let uu____12489 = wl_to_string wl in
         let uu____12490 =
           FStar_Util.string_of_int
      ...
      (let g =
         let uu____12502 = solve_and_commit env wl fail in
         match uu____12502 with
         | Some [] ->
             let uu___173_12509 = g in
             {
               FStar_TypeChecker_Env.guard_f =
                 (uu___173_12509.FStar_TypeChecker_Env.guard_f);
               FStar_TypeChecker_Env.deferred = [];
               FStar_TypeChecker_Env.univ_ineqs =
                 (uu___173_12509.FStar_TypeChecker_Env.univ_ineqs);
               FStar_TypeChecker_Env.implicits =
                 (uu___173_12509.FStar_TypeChecker_Env.implicits)
             }
         | uu____12512 ->
             failwith "impossible: Unexpected deferred constraints remain" in
       solve_universe_inequalities env g.FStar_TypeChecker_Env.univ_ineqs;
       (let uu___174_12515 = g in
        {
          FStar_TypeChecker_Env.guard_f =
            (uu___174_12515.FStar_TypeChecker_Env.guard_f);
          FStar_TypeChecker_Env.deferred =
            (uu___174_12515.FStar_TypeChecker_Env.deferred);
          FStar_TypeChecker_Env.univ_ineqs = ([], []);
          FStar_TypeChecker_Env.implicits =
            (uu___174_12515.FStar_TypeChecker_Env.implicits)
        }))
let discharge_guard':
    ...
    fun env  ->
      fun g  ->
        fun use_smt  ->
          ...
          let ret_g =
            let uu___175_12541 = g in
            {
              FStar_TypeChecker_Env.guard_f =
                FStar_TypeChecker_Common.Trivial;
              FStar_TypeChecker_Env.deferred =
                (uu___175_12541.FStar_TypeChecker_Env.deferred);
              FStar_TypeChecker_Env.univ_ineqs =
                (uu___175_12541.FStar_TypeChecker_Env.univ_ineqs);
              FStar_TypeChecker_Env.implicits =
                (uu___175_12541.FStar_TypeChecker_Env.implicits)
            } in
          let uu____12542 =
            let uu____12543 = FStar_TypeChecker_Env.should_verify env in
             ...
             | FStar_TypeChecker_Common.NonTrivial vc ->
                 ((let uu____12549 =
                   ...
                   then
                     ...
                     let uu____12551 =
                       let uu____12552 = FStar_Syntax_Print.term_to_string vc in
                       FStar_Util.format1 "Before normalization VC=\n%s\n"
                         uu____12552 in
                     FStar_Errors.diag uu____12550 uu____12551
                   else ());
                  (let vc =
                     FStar_TypeChecker_Normalize.normalize
                       [FStar_TypeChecker_Normalize.Eager_unfolding;
                           ...
                           then
                             ...
                             let uu____12563 =
                               ...
                               FStar_Util.format1 "Checking VC=\n%s\n"
                                 uu____12564 in
                             FStar_Errors.diag uu____12562 uu____12563
                           else ());
...
let discharge_guard:
  ...
  fun env  ->
    fun g  ->
      let uu____12572 = discharge_guard' None env g true in
...
let resolve_implicits:
  ...
  fun g  ->
    let unresolved u =
      let uu____12592 = FStar_Unionfind.find u in
      match uu____12592 with
      | FStar_Syntax_Syntax.Uvar  -> true
      | uu____12601 -> false in
    let rec until_fixpoint acc implicits =
      let uu____12616 = acc in
      ...
      | (out,changed) ->
          (match implicits with
           ...
           | hd::tl ->
               let uu____12662 = hd in
               (match uu____12662 with
                | (uu____12669,env,u,tm,k,r) ->
                    let uu____12675 = unresolved u in
                    if uu____12675
                       ...
                       (let uu____12693 =
                        ...
                        then
                          ...
                          FStar_Util.print3
                            ...
                            uu____12694 uu____12698 uu____12699
                        else ());
                       (let uu____12701 =
                          env.FStar_TypeChecker_Env.type_of
                            (let uu___176_12705 = env in
                             {
                               FStar_TypeChecker_Env.solver =
                                 (uu___176_12705.FStar_TypeChecker_Env.solver);
                               FStar_TypeChecker_Env.range =
                                 (uu___176_12705.FStar_TypeChecker_Env.range);
                               FStar_TypeChecker_Env.curmodule =
                                 (uu___176_12705.FStar_TypeChecker_Env.curmodule);
                               FStar_TypeChecker_Env.gamma =
                                 (uu___176_12705.FStar_TypeChecker_Env.gamma);
                               FStar_TypeChecker_Env.gamma_cache =
                                 (uu___176_12705.FStar_TypeChecker_Env.gamma_cache);
                               FStar_TypeChecker_Env.modules =
                                 (uu___176_12705.FStar_TypeChecker_Env.modules);
                               FStar_TypeChecker_Env.expected_typ =
                                 (uu___176_12705.FStar_TypeChecker_Env.expected_typ);
                               FStar_TypeChecker_Env.sigtab =
                                 (uu___176_12705.FStar_TypeChecker_Env.sigtab);
                               FStar_TypeChecker_Env.is_pattern =
                                 (uu___176_12705.FStar_TypeChecker_Env.is_pattern);
                               FStar_TypeChecker_Env.instantiate_imp =
                                 (uu___176_12705.FStar_TypeChecker_Env.instantiate_imp);
                               FStar_TypeChecker_Env.effects =
                                 (uu___176_12705.FStar_TypeChecker_Env.effects);
                               FStar_TypeChecker_Env.generalize =
                                 (uu___176_12705.FStar_TypeChecker_Env.generalize);
                               FStar_TypeChecker_Env.letrecs =
                                 (uu___176_12705.FStar_TypeChecker_Env.letrecs);
                               FStar_TypeChecker_Env.top_level =
                                 (uu___176_12705.FStar_TypeChecker_Env.top_level);
                               FStar_TypeChecker_Env.check_uvars =
                                 (uu___176_12705.FStar_TypeChecker_Env.check_uvars);
                               FStar_TypeChecker_Env.use_eq =
                                 (uu___176_12705.FStar_TypeChecker_Env.use_eq);
                               FStar_TypeChecker_Env.is_iface =
                                 (uu___176_12705.FStar_TypeChecker_Env.is_iface);
                               FStar_TypeChecker_Env.admit =
                                 (uu___176_12705.FStar_TypeChecker_Env.admit);
                               FStar_TypeChecker_Env.lax =
                                 (uu___176_12705.FStar_TypeChecker_Env.lax);
                               FStar_TypeChecker_Env.lax_universes =
                                 (uu___176_12705.FStar_TypeChecker_Env.lax_universes);
                               FStar_TypeChecker_Env.type_of =
                                 (uu___176_12705.FStar_TypeChecker_Env.type_of);
                               FStar_TypeChecker_Env.universe_of =
                                 (uu___176_12705.FStar_TypeChecker_Env.universe_of);
                               FStar_TypeChecker_Env.use_bv_sorts = true;
                               FStar_TypeChecker_Env.qname_and_index =
                                 (uu___176_12705.FStar_TypeChecker_Env.qname_and_index)
                             }) tm in
                        match uu____12701 with
                        | (uu____12706,uu____12707,g) ->
                            let g =
                              if env.FStar_TypeChecker_Env.is_pattern
                              then
                                let uu___177_12710 = g in
                                {
                                  FStar_TypeChecker_Env.guard_f =
                                    FStar_TypeChecker_Common.Trivial;
                                  FStar_TypeChecker_Env.deferred =
                                    (uu___177_12710.FStar_TypeChecker_Env.deferred);
                                  FStar_TypeChecker_Env.univ_ineqs =
                                    (uu___177_12710.FStar_TypeChecker_Env.univ_ineqs);
                                  FStar_TypeChecker_Env.implicits =
                                    (uu___177_12710.FStar_TypeChecker_Env.implicits)
                                }
                              else g in
                            let g' =
                              let uu____12713 =
                            ...
                            until_fixpoint
                              ((FStar_List.append
                                ...
                                true) tl)))) in
    let uu___178_12732 = g in
    let uu____12733 =
      until_fixpoint ([], false) g.FStar_TypeChecker_Env.implicits in
    {
      FStar_TypeChecker_Env.guard_f =
        (uu___178_12732.FStar_TypeChecker_Env.guard_f);
      FStar_TypeChecker_Env.deferred =
        (uu___178_12732.FStar_TypeChecker_Env.deferred);
      FStar_TypeChecker_Env.univ_ineqs =
        (uu___178_12732.FStar_TypeChecker_Env.univ_ineqs);
      FStar_TypeChecker_Env.implicits = uu____12733
    }
let force_trivial_guard:
  ...
  fun env  ->
    fun g  ->
      let g =
        let uu____12761 = solve_deferred_constraints env g in
        FStar_All.pipe_right uu____12761 resolve_implicits in
      match g.FStar_TypeChecker_Env.implicits with
      | [] ->
          let uu____12768 = discharge_guard env g in
          FStar_All.pipe_left Prims.ignore uu____12768
      | (reason,uu____12770,uu____12771,e,t,r)::uu____12775 ->
          let uu____12789 =
            let uu____12790 = FStar_Syntax_Print.term_to_string t in
            let uu____12791 = FStar_Syntax_Print.term_to_string e in
            FStar_Util.format3
              "Failed to resolve implicit argument of type '%s' introduced in %s because %s"
              uu____12790 uu____12791 reason in
          FStar_Errors.report r uu____12789
let universe_inequality:
  ...
  fun u1  ->
    fun u2  ->
      let uu___179_12798 = trivial_guard in
      {
        FStar_TypeChecker_Env.guard_f =
          (uu___179_12798.FStar_TypeChecker_Env.guard_f);
        FStar_TypeChecker_Env.deferred =
          (uu___179_12798.FStar_TypeChecker_Env.deferred);
        FStar_TypeChecker_Env.univ_ineqs = ([], [(u1, u2)]);
        FStar_TypeChecker_Env.implicits =
          (uu___179_12798.FStar_TypeChecker_Env.implicits)
      }
let teq_nosmt:
  FStar_TypeChecker_Env.env ->
  ...
  fun env  ->
    fun t1  ->
      fun t2  ->
        let uu____12816 = try_teq env t1 t2 in
        match uu____12816 with
        | None  -> false
        | Some g ->
            let uu____12819 = discharge_guard' None env g false in
            (match uu____12819 with
             | Some uu____12823 -> true
             | None  -> false)