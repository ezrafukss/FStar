                          ...
                          FStar_All.pipe_right rest
                            (FStar_List.for_all
                               (fun u  ->
                                  ...
                                  | (uu____950,m) -> n <= m)) in
                        if uu____944 then rest else us
                    | uu____954 -> us)
               | uu____957 -> us)
                  ...
                  (match uu____3263 with
                   | (FStar_Syntax_Syntax.Tm_app
                      ...
                      (head2,(arg2,uu____3281)::[])) ->
                       let uu____3324 =
                         let uu____3329 =
                           let uu____3330 = FStar_Syntax_Subst.compress head1 in
                           uu____3330.FStar_Syntax_Syntax.n in
                         let uu____3333 =
                           let uu____3334 = FStar_Syntax_Subst.compress head2 in
                           uu____3334.FStar_Syntax_Syntax.n in
                         let uu____3337 =
                           let uu____3338 = FStar_Syntax_Subst.compress arg1 in
                           uu____3338.FStar_Syntax_Syntax.n in
                         let uu____3341 =
                           let uu____3342 = FStar_Syntax_Subst.compress arg2 in
              ...
              | Some (uu____3464,op) ->
                  ...
                  (match uu____3480 with
                   | FStar_Syntax_Syntax.Tm_constant
                       ...
                       let uu____3490 = FStar_Bytes.unicode_bytes_as_string b in
                       op uu____3490
                   | uu____3491 -> tm))
                  ...
                  (let uu____3969 =
                   ...
                   then
                     ...
                     | _::(Some (true ),_)::[]|(Some (false ),_)::_::[] ->
                         w FStar_Syntax_Util.t_true
                     | (Some (true ),uu____4063)::(uu____4064,(arg,uu____4066))::[]
                         -> arg
                     | uu____4107 -> tm
                   else
                     (let uu____4117 =
          ...
          (match t.FStar_Syntax_Syntax.n with
           ...
           | FStar_Syntax_Syntax.Tm_fvar f ->
               ...
               then rebuild cfg env stack t
                 ...
                 (let r_env =
                    ...
                    FStar_TypeChecker_Env.set_range cfg.tcenv uu____4789 in
                  let uu____4790 =
                          ...
                          | uu____4950::[] ->
                              (match lopt with
                               | None  when FStar_Options.__unit_tests () ->
                                   (log cfg
                                      (fun uu____4963  ->
                                         let uu____4964 = closure_to_string c in
                               ...
                               | Some (FStar_Util.Inr (l,cflags)) when
                                   ...
                                   (log cfg
                                      (fun uu____4981  ->
                                         let uu____4982 = closure_to_string c in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____4982);
                                    norm cfg (c :: env) stack_rest body)
                               | Some (FStar_Util.Inl lc) when
                                   ...
                                   (log cfg
                                      (fun uu____4993  ->
                                         let uu____4994 = closure_to_string c in
                                         FStar_Util.print1 "\tShifted %s\n"
                                           uu____4994);
                                    norm cfg (c :: env) stack_rest body)
                               | uu____4995 when
                               ...
                               | uu____5002 ->
                                   ...
                                   let uu____5011 = closure_as_term cfg env t in
                ...
                | (Debug _)::_
                  |(Meta _)::_|(Let _)::_|(App _)::_|(Abs _)::_|[] ->
                    ...
                    then
                      ...
                      (let uu____5071 = FStar_Syntax_Subst.open_term' bs body in
                       ...
                       | (bs,body,opening) ->
                           ...
                           let env' =
                             FStar_All.pipe_right bs
                               (FStar_List.fold_left
                                  (fun env  ->
                                     fun uu____5147  -> Dummy :: env) env) in
                           (log cfg
                              (fun uu____5152  ->
                                 let uu____5153 =
                                   FStar_All.pipe_left
           ...
           | FStar_Syntax_Syntax.Tm_refine (x,f) ->
               ...
               then
                 ...
                 (let t_x = norm cfg env [] x.FStar_Syntax_Syntax.sort in
                  let uu____5262 = FStar_Syntax_Subst.open_term [(x, None)] f in
                  ...
                  | (bs,c) ->
                      let c =
                        let uu____5306 =
                          FStar_All.pipe_right bs
                            (FStar_List.fold_left
                               (fun env  -> fun uu____5312  -> Dummy :: env)
                               env) in
                             ...
                             let uu____5747 =
                               let uu____5748 =
                                 ...
                                 (rec_env, (lb.FStar_Syntax_Syntax.lbdef),
                                   uu____5758, false) in
                               Clos uu____5748 in
                             uu____5747 :: env) (Prims.snd lbs) env in
               ...
               (match m with
                | FStar_Syntax_Syntax.Meta_monadic (m,t) ->
                    ...
                    then
                      ...
                      (let uu____5815 =
                         let uu____5816 = FStar_Syntax_Subst.compress head in
                       ...
                       | FStar_Syntax_Syntax.Tm_let ((false ,lb::[]),body) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m in
                           let uu____5830 = ed.FStar_Syntax_Syntax.bind_repr in
                                 ...
                                 | FStar_Util.Inl x ->
                                     let is_return e =
                                       let uu____5842 =
                                         ...
                                         uu____5843.FStar_Syntax_Syntax.n in
                                     ...
                                     (match uu____5878 with
                                      | Some e ->
                                          ...
                                          norm cfg env uu____5883 uu____5884
                                      | None  ->
                                          let uu____5914 =
                                            let uu____5915 = is_return body in
                                          ...
                                          then
                                            ...
                                            (let head =
                                             ...
                                             let uu____6085 =
                                               FStar_List.tl stack in
                                             norm cfg env uu____6085 reified))))
                       | FStar_Syntax_Syntax.Tm_app (head,args) ->
                           let ed =
                             FStar_TypeChecker_Env.get_effect_decl cfg.tcenv
                               m in
                           let uu____6103 = ed.FStar_Syntax_Syntax.bind_repr in
                            ...
                            | (uu____6104,bind_repr) ->
                                let maybe_unfold_action head =
                                  let maybe_extract_fv t =
                                    ...
                                    | uu____6146 -> None in
                                  let uu____6147 = maybe_extract_fv head in
                                           ...
                                           let body =
                                             let uu____6294 =
                                               let uu____6300 =
                                                 ...
                                                 (uu____6303, q) in
                                               uu____6300 :: acc in
                                             bind_on_lift es uu____6294 in
                                           let lifted_e0 =
                                             reify_lift cfg.tcenv e0 m1 m2 t' in
                                           let continuation =
                ...
                | FStar_Syntax_Syntax.Meta_monadic_lift (m,m',t) ->
                    ...
                    then
                      ...
                      let uu____6629 = reify_lift cfg.tcenv head m m' t in
            ...
            then
              ...
              | (uu____6696,return_repr) ->
                  let return_inst =
                    ...
                    | FStar_Syntax_Syntax.Tm_uinst (return_tm,uu____6710::[])
                        ->
                        let uu____6716 =
                          let uu____6719 =
                            let uu____6720 =
                    ...
                    let uu____6745 =
                      let uu____6746 =
                        let uu____6756 =
                          ...
                          let uu____6759 =
                            let uu____6761 = FStar_Syntax_Syntax.as_arg e in
                            [uu____6761] in
              ...
              (let uu____6774 = FStar_TypeChecker_Env.monad_leq env msrc mtgt in
        ...
        | FStar_Syntax_Syntax.Comp ct ->
            ...
            let uu____6953 =
              let uu____6954 =
                ...
                let uu____6960 = norm_args ct.FStar_Syntax_Syntax.effect_args in
                {
              ...
              (if uu____7083
               then
                 let uu____7087 =
                   let uu____7090 =
                     let uu____7091 =
                       let uu____7094 = FStar_Syntax_Syntax.mk_Total t in
                       FStar_Syntax_Util.comp_set_flags uu____7094 flags in
                 ...
                 (let uu____7098 =
                    let uu____7101 =
                      let uu____7102 =
                        let uu____7105 = FStar_Syntax_Syntax.mk_GTotal t in
                        FStar_Syntax_Util.comp_set_flags uu____7105 flags in
              ...
              (log cfg
               ...
               (let scrutinee = t in
                ...
                let rec matches_pat scrutinee p =
                  ...
                  let uu____7834 = FStar_Syntax_Util.head_and_args scrutinee in
                  ...
                  | (head,args) ->
                      (match p.FStar_Syntax_Syntax.v with
                       ...
                       | FStar_Syntax_Syntax.Pat_cons (fv,arg_pats) ->
                           let uu____7950 =
                             let uu____7951 = FStar_Syntax_Util.un_uinst head in
                      ...
                      (match uu____8025 with
                       | FStar_Util.Inl s ->
                           matches_args (FStar_List.append out s) rest_a
                             rest_p
                       | m -> m)
                  | uu____8039 -> FStar_Util.Inr false in
                                 ...
                                 (fun env  ->
                                    fun t  ->
                                      let uu____8132 =
                                        ...
                                        Clos uu____8133 in
                                      uu____8132 :: env) env s in
                             let uu____8166 = guard_when_clause wopt b rest in
                             norm cfg env stack uu____8166))) in
                let uu____8167 =
                  FStar_All.pipe_right cfg.steps
...
let normalize_universe:
  ...
  =
  fun env  ->
    fun u  -> let uu____8216 = config [] env in norm_universe uu____8216 [] u
let ghost_to_pure:
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.comp ->
      (FStar_Syntax_Syntax.comp',Prims.unit) FStar_Syntax_Syntax.syntax
          ...
          | FStar_Syntax_Syntax.Tm_refine (x,phi) ->
              ...
              (match t0.FStar_Syntax_Syntax.n with
               | FStar_Syntax_Syntax.Tm_refine (y,phi1) ->
                   let uu____8293 =
                     let uu____8294 =
                       let uu____8299 = FStar_Syntax_Util.mk_conj phi1 phi in
                       (y, uu____8299) in
           ...
           | (head,args) ->
               ...
               (match uu____8438 with
                | FStar_Syntax_Syntax.Tm_uvar (uu____8442,thead) ->
                    let uu____8456 = FStar_Syntax_Util.arrow_formals thead in
