                       ...
                       (let f =
                        ...
                        | FStar_Syntax_Syntax.Tm_abs
                            (uu____4228,{
                                          ...
                                          FStar_Syntax_Syntax.tk = uu____4230;
                         ...
                         (match uu____4503 with
                          | (us_e,uu____4510) ->
                              ...
                              let as_req =
                                ...
                                FStar_Syntax_Syntax.mk_Tm_uinst uu____4513
                                  us_r in
                              let as_ens =
                                let uu____4515 =
                                  FStar_Syntax_Syntax.fvar
                              ...
                              let ens =
                                ...
                                uu____4544 None
                                  (ct.FStar_Syntax_Syntax.result_typ).FStar_Syntax_Syntax.pos in
                              let uu____4566 =
                                let uu____4568 = norm req in Some uu____4568 in
                              let uu____4569 =
                                let uu____4570 =
                                  mk_post_type
             ...
             | Some expected_t ->
                 ...
                 then
                   let uu____4750 =
                     let uu____4751 =
                       let uu____4754 =
                         let uu____4755 = FStar_Util.string_of_int n_expected in
                       ...
                       let uu____4764 = FStar_TypeChecker_Env.get_range env in
                         ...
                         (match (args, bs) with
                          ...
                          | uu____5101 ->
                              let t =
                                ...
                                | uu____5120 -> FStar_Syntax_Util.arrow bs c in
            ...
            then FStar_TypeChecker_Rel.try_teq env t1 t2
              ...
              (let uu____6359 = FStar_TypeChecker_Rel.try_subtype env t1 t2 in
               ...
               | Some f ->
                   ...
                   FStar_All.pipe_left (fun _0_31  -> Some _0_31) uu____6363) in
          let is_var e =
            let uu____6369 =
            ...
            FStar_Util.find_map table
              (fun uu____6757  ->
                 ...
                 | (x,mk) ->
                     ...
                     then let uu____6770 = mk seen_args in Some uu____6770
                     else None) in
      ...
      then
        ...
        (if (FStar_List.length quals) <> (FStar_List.length no_dup_quals)
         ...
         (let uu____7402 =
          ...
          if uu____7402 then err "ill-formed combination" else ());
         (match se with
          | FStar_Syntax_Syntax.Sig_let
                                    ...
                                    let uu____7912 =
                                      ...
                                      FStar_All.pipe_right uu____7913
                                        (fun fv  ->
                                           (fv.FStar_Syntax_Syntax.fv_name).FStar_Syntax_Syntax.v) in
                                    [uu____7912] in
                                  ((false, [lb]), p, uu____7910, quals, []) in
