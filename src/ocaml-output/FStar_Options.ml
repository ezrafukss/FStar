...
let display_version: Prims.unit -> Prims.unit =
  fun uu____788  ->
    let uu____789 =
      ...
      FStar_Util.format5
        "F* %s\nplatform=%s\ncompiler=%s\ndate=%s\ncommit=%s\n" uu____790
        uu____793 uu____796 uu____799 uu____802 in
    ...
    | (ns,name,arg,desc) ->
        let arg =
          ...
          | FStar_Getopt.ZeroArgs f ->
              let g uu____899 =
                let uu____900 = let uu____903 = f () in (name, uu____903) in
  ...
  fun uu____973  ->
    let specs =
      ...
      (FStar_Getopt.noshort, "codegen",
        (FStar_Getopt.OneArg
           (((fun s  -> let uu____1012 = parse_codegen s in String uu____1012)),
      ...
      (FStar_Getopt.noshort, "codegen-lib",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1022 =
                  let uu____1024 =
                    let uu____1026 = get_codegen_lib () in s :: uu____1026 in
      ...
      (FStar_Getopt.noshort, "debug_level",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1056 =
                  let uu____1058 =
                    let uu____1060 = get_debug_level () in x :: uu____1060 in
      ...
      (FStar_Getopt.noshort, "dump_module",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1097 =
                  let uu____1099 =
                    let uu____1101 = get_dump_module () in x :: uu____1101 in
      ...
      (FStar_Getopt.noshort, "initial_fuel",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1212 = FStar_Util.int_of_string x in Int uu____1212)),
      ...
      (FStar_Getopt.noshort, "no_extract",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1314 =
                  let uu____1316 =
                    let uu____1318 = get_no_extract () in x :: uu____1318 in
      ...
      (FStar_Getopt.noshort, "split_cases",
        (FStar_Getopt.OneArg
           (((fun n  ->
                let uu____1457 = FStar_Util.int_of_string n in Int uu____1457)),
             "[positive integer]")),
      ...
      (FStar_Getopt.noshort, "__temp_no_proj",
        (FStar_Getopt.OneArg
           (((fun x  ->
                let uu____1517 =
                  let uu____1519 =
                    let uu____1521 = get___temp_no_proj () in x :: uu____1521 in
      ...
      (FStar_Getopt.noshort, "z3rlimit",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1573 = FStar_Util.int_of_string s in Int uu____1573)),
             "[positive integer]")),
        "Set the Z3 per-query resource limit (default 5 units, taking roughtly 5s)");
      (FStar_Getopt.noshort, "z3seed",
        (FStar_Getopt.OneArg
           (((fun s  ->
                let uu____1583 = FStar_Util.int_of_string s in Int uu____1583)),
    ...
    let res =
      ...
      FStar_Getopt.parse_cmdline uu____1768
        (fun i  ->
           ...
           FStar_ST.write file_list_ uu____1771) in
                ...
                (fun f  ->
                   ...
                   let f =
                     let uu____1826 =
                       let uu____1827 =
                         let uu____1828 =
                           let uu____1829 = FStar_Util.get_file_extension f in
...
let hint_info: Prims.unit -> Prims.bool = fun uu____1992  -> get_hint_info ()
let indent: Prims.unit -> Prims.bool = fun uu____1995  -> get_indent ()
let initial_fuel: Prims.unit -> Prims.int =
  fun uu____1998  -> get_initial_fuel ()
let initial_ifuel: Prims.unit -> Prims.int =
  fun uu____2001  -> get_initial_ifuel ()
let inline_arith: Prims.unit -> Prims.bool =
  fun uu____2004  -> get_inline_arith ()
let interactive: Prims.unit -> Prims.bool = fun uu____2007  -> get_in ()
let lax: Prims.unit -> Prims.bool = fun uu____2010  -> get_lax ()
let log_queries: Prims.unit -> Prims.bool =
  fun uu____2013  -> get_log_queries ()
let log_types: Prims.unit -> Prims.bool = fun uu____2016  -> get_log_types ()
let max_fuel: Prims.unit -> Prims.int = fun uu____2019  -> get_max_fuel ()
let max_ifuel: Prims.unit -> Prims.int = fun uu____2022  -> get_max_ifuel ()
let min_fuel: Prims.unit -> Prims.int = fun uu____2025  -> get_min_fuel ()
let ml_ish: Prims.unit -> Prims.bool = fun uu____2028  -> get_MLish ()
let set_ml_ish: Prims.unit -> Prims.unit =
  fun uu____2031  -> set_option "MLish" (Bool true)
let n_cores: Prims.unit -> Prims.int = fun uu____2034  -> get_n_cores ()
let no_default_includes: Prims.unit -> Prims.bool =
  fun uu____2037  -> get_no_default_includes ()
let no_extract: Prims.string -> Prims.bool =
  fun s  ->
    let uu____2041 = get_no_extract () in
    FStar_All.pipe_right uu____2041 (FStar_List.contains s)
let no_location_info: Prims.unit -> Prims.bool =
  fun uu____2046  -> get_no_location_info ()
let norm_then_print: Prims.unit -> Prims.bool =
  fun uu____2049  ->
    let uu____2050 = get_print_before_norm () in uu____2050 = false
let output_dir: Prims.unit -> Prims.string Prims.option =
  fun uu____2054  -> get_odir ()
let print_bound_var_types: Prims.unit -> Prims.bool =
  fun uu____2057  -> get_print_bound_var_types ()
let print_effect_args: Prims.unit -> Prims.bool =
  fun uu____2060  -> get_print_effect_args ()
let print_fuels: Prims.unit -> Prims.bool =
  fun uu____2063  -> get_print_fuels ()
let print_implicits: Prims.unit -> Prims.bool =
  fun uu____2066  -> get_print_implicits ()
let print_real_names: Prims.unit -> Prims.bool =
  fun uu____2069  -> get_prn ()
let print_universes: Prims.unit -> Prims.bool =
  fun uu____2072  -> get_print_universes ()
let print_z3_statistics: Prims.unit -> Prims.bool =
  fun uu____2075  -> get_print_z3_statistics ()
let record_hints: Prims.unit -> Prims.bool =
  fun uu____2078  -> get_record_hints ()
let reuse_hint_for: Prims.unit -> Prims.string Prims.option =
  fun uu____2082  -> get_reuse_hint_for ()
let silent: Prims.unit -> Prims.bool = fun uu____2085  -> get_silent ()
let split_cases: Prims.unit -> Prims.int =
  fun uu____2088  -> get_split_cases ()
let timing: Prims.unit -> Prims.bool = fun uu____2091  -> get_timing ()
let trace_error: Prims.unit -> Prims.bool =
  fun uu____2094  -> get_trace_error ()
let unthrottle_inductives: Prims.unit -> Prims.bool =
  fun uu____2097  -> get_unthrottle_inductives ()
let use_eq_at_higher_order: Prims.unit -> Prims.bool =
  fun uu____2100  -> get_use_eq_at_higher_order ()
let use_hints: Prims.unit -> Prims.bool = fun uu____2103  -> get_use_hints ()
let verify_all: Prims.unit -> Prims.bool =
  fun uu____2106  -> get_verify_all ()
let verify_module: Prims.unit -> Prims.string Prims.list =
  fun uu____2110  -> get_verify_module ()
let warn_cardinality: Prims.unit -> Prims.bool =
  fun uu____2113  ->
    let uu____2114 = get_cardinality () in uu____2114 = "warn"
let warn_default_effects: Prims.unit -> Prims.bool =
  fun uu____2117  -> get_warn_default_effects ()
let warn_top_level_effects: Prims.unit -> Prims.bool =
  fun uu____2120  -> get_warn_top_level_effects ()
let z3_exe: Prims.unit -> Prims.string =
  fun uu____2123  ->
    let uu____2124 = get_smt () in
    match uu____2124 with | None  -> FStar_Platform.exe "z3" | Some s -> s
let z3_cliopt: Prims.unit -> Prims.string Prims.list =
  fun uu____2130  -> get_z3cliopt ()
let z3_refresh: Prims.unit -> Prims.bool =
  fun uu____2133  -> get_z3refresh ()
let z3_rlimit: Prims.unit -> Prims.int = fun uu____2136  -> get_z3rlimit ()
let z3_seed: Prims.unit -> Prims.int = fun uu____2139  -> get_z3seed ()
let z3_timeout: Prims.unit -> Prims.int = fun uu____2142  -> get_z3timeout ()
let no_positivity: Prims.unit -> Prims.bool =
  fun uu____2145  -> get_no_positivity ()
let should_extract: Prims.string -> Prims.bool =
  fun m  ->
    (let uu____2149 = no_extract m in Prims.op_Negation uu____2149) &&
      ((extract_all ()) ||
         (let uu____2150 = get_extract_module () in
          match uu____2150 with
          | [] ->
              let uu____2152 = get_extract_namespace () in
