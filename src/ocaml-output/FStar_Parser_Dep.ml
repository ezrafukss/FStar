        ...
        fun original_map  ->
          fun filename  ->
            ...
            (let num_of_toplevelmods =
             ...
             let rec collect_module uu___83_1368 =
               match uu___83_1368 with
             ...
             and collect_decls decls =
               FStar_List.iter
                 ...
                 decls
             and collect_decl uu___84_2481 =
               match uu___84_2481 with
             ...
             and collect_tycon uu___85_2680 =
               match uu___85_2680 with
             ...
             and collect_effect_decl uu___86_2853 =
               match uu___86_2853 with
             ...
             and collect_binder uu___87_2879 =
               match uu___87_2879 with
               | {
             ...
             and collect_constant uu___88_2896 =
               match uu___88_2896 with
               ...
               | uu____2915 -> ()
             and collect_term' uu___89_2916 =
               match uu___89_2916 with
             ...
             and collect_pattern' uu___90_3202 =
               match uu___90_3202 with
               ...
               | FStar_Parser_AST.PatVector ps -> collect_patterns ps
               | FStar_Parser_AST.PatOr ps -> collect_patterns ps
               | FStar_Parser_AST.PatTuple (ps,uu____3237) ->
                   collect_patterns ps
               | FStar_Parser_AST.PatRecord lidpats ->
                   FStar_List.iter
                     (fun uu____3256  ->
                        match uu____3256 with
                        | (uu____3261,p) -> collect_pattern p) lidpats
               | FStar_Parser_AST.PatAscribed (p,t) ->
                   (collect_pattern p; collect_term t)
             and collect_branches bs = FStar_List.iter collect_branch bs
             and collect_branch uu____3285 =
               match uu____3285 with
               | (pat,t1,t2) ->
                   (collect_pattern pat;
                    FStar_Util.iter_opt t1 collect_term;
                    collect_term t2) in
             let uu____3303 = FStar_Parser_Driver.parse_file filename in
             match uu____3303 with
             | (ast,uu____3317) ->
                 (collect_module ast; FStar_ST.op_Bang deps))
let print_graph:
  'Auu____3399 .
    (Prims.string Prims.list,'Auu____3399) FStar_Pervasives_Native.tuple2
    ...
    (let uu____3423 =
       let uu____3424 =
         let uu____3425 =
           let uu____3426 =
             let uu____3429 =
               let uu____3432 = FStar_Util.smap_keys graph in
               FStar_List.unique uu____3432 in
             FStar_List.collect
               (fun k  ->
                  let deps =
                    let uu____3448 =
                      let uu____3455 = FStar_Util.smap_try_find graph k in
                      FStar_Util.must uu____3455 in
                    FStar_Pervasives_Native.fst uu____3448 in
     ...
     FStar_Util.write_file "dep.graph" uu____3423)
let collect:
  verify_mode ->
  ...
  fun verify_mode  ->
    fun filenames  ->
      ...
      let verify_flags =
        let uu____3544 = FStar_Options.verify_module () in
        FStar_List.map
          (fun f  ->
             let uu____3556 = FStar_Util.mk_ref false in (f, uu____3556))
          uu____3544 in
      let partial_discovery =
        let uu____3576 =
          (FStar_Options.verify_all ()) || (FStar_Options.extract_all ()) in
        Prims.op_Negation uu____3576 in
      let m = build_map filenames in
      let file_names_of_key k =
        let uu____3582 =
          let uu____3591 = FStar_Util.smap_try_find m k in
          FStar_Util.must uu____3591 in
        ...
        | (intf,impl) ->
            (match (intf, impl) with
             ...
             | (FStar_Pervasives_Native.Some i,FStar_Pervasives_Native.None )
                 -> i
             | (FStar_Pervasives_Native.Some i,uu____3647) when
                 partial_discovery -> i
      ...
      let rec discover_one is_user_provided_filename interface_only key =
        let uu____3679 =
          let uu____3680 = FStar_Util.smap_try_find graph key in
          uu____3680 = FStar_Pervasives_Native.None in
        if uu____3679
        then
          let uu____3709 =
            let uu____3718 = FStar_Util.smap_try_find m key in
            FStar_Util.must uu____3718 in
          ...
          | (intf,impl) ->
              ...
              let impl_deps =
                ...
                | (FStar_Pervasives_Native.Some
                   impl1,FStar_Pervasives_Native.Some uu____3771) when
                    interface_only -> []
                | (FStar_Pervasives_Native.Some impl1,uu____3777) ->
                    collect_one1 is_user_provided_filename m impl1
                | (FStar_Pervasives_Native.None ,uu____3784) -> [] in
              let deps =
        ...
        let interface_only =
          (is_interface f) &&
            (let uu____3811 =
               FStar_List.existsML
                 (fun f1  ->
                    (let uu____3816 = lowercase_module_name f1 in
                     uu____3816 = m1) && (is_implementation f1)) filenames in
             Prims.op_Negation uu____3811) in
      ...
      (let immediate_graph = FStar_Util.smap_copy graph in
       ...
       let rec discover cycle key =
         let uu____3853 =
           let uu____3860 = FStar_Util.smap_try_find graph key in
           FStar_Util.must uu____3860 in
                   ...
                   (let all_deps =
                      let uu____3916 =
                        let uu____3919 =
                          FStar_List.map
                            (fun dep1  ->
                               let uu____3929 = discover (key :: cycle) dep1 in
                               dep1 :: uu____3929) direct_deps in
                        FStar_List.flatten uu____3919 in
                      FStar_List.unique uu____3916 in
                    FStar_Util.smap_add graph key (all_deps, Black);
                    (let uu____3942 =
                       let uu____3945 = FStar_ST.op_Bang topologically_sorted in
                       key :: uu____3945 in
                     FStar_ST.op_Colon_Equals topologically_sorted uu____3942);
                    all_deps))) in
       let discover1 = discover [] in
       let must_find k =
         let uu____4087 =
           let uu____4096 = FStar_Util.smap_try_find m k in
           FStar_Util.must uu____4096 in
               ...
               (let uu____4132 =
                  FStar_List.existsML
                    (fun f  ->
                       ...
                       uu____4136 = k) filenames in
                Prims.op_Negation uu____4132)
             -> [intf; impl]
         | (FStar_Pervasives_Native.Some intf,FStar_Pervasives_Native.Some
            impl) when
             FStar_List.existsML
               (fun f  ->
                  (is_implementation f) &&
                    (let uu____4146 = lowercase_module_name f in
                     uu____4146 = k)) filenames
             -> [intf; impl]
         | (FStar_Pervasives_Native.Some intf,uu____4148) -> [intf]
         | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.Some impl)
             -> [impl]
         | (FStar_Pervasives_Native.None ,FStar_Pervasives_Native.None ) ->
             [] in
       let must_find_r f =
         let uu____4170 = must_find f in FStar_List.rev uu____4170 in
       let by_target =
         let uu____4182 =
           let uu____4185 = FStar_Util.smap_keys graph in
           ...
           (fun k  ->
              ...
              FStar_List.map
                (fun f  ->
                   ...
                   let suffix =
                     let uu____4230 =
                       let uu____4239 = FStar_Util.smap_try_find m k1 in
                       FStar_Util.must uu____4239 in
                     match uu____4230 with
                     | (FStar_Pervasives_Native.Some intf,uu____4269) when
                         should_append_fsti -> [intf]
                     | uu____4276 -> [] in
                   let deps =
                     let uu____4288 = discover1 k1 in
                     FStar_List.rev uu____4288 in
                   let deps_as_filenames =
                     let uu____4294 = FStar_List.collect must_find deps in
                     FStar_List.append uu____4294 suffix in
                   (f, deps_as_filenames)) as_list) uu____4182 in
       let topologically_sorted1 =
         let uu____4302 = FStar_ST.op_Bang topologically_sorted in
         FStar_List.collect must_find_r uu____4302 in
       FStar_List.iter
         (fun uu____4474  ->
            match uu____4474 with
            | (m1,r) ->
                let uu____4763 =
                  (let uu____4766 = FStar_ST.op_Bang r in
                   Prims.op_Negation uu____4766) &&
                    (let uu____4910 = FStar_Options.interactive () in
                     Prims.op_Negation uu____4910) in
                if uu____4763
                then
                  let maybe_fst =
                    ...
                    then
                      ...
                      FStar_Util.format1 " Did you mean %s ?" uu____4928
                    else "" in
                  let uu____4936 =
                    let uu____4937 =
                      FStar_Util.format3
                        ...
                        m1 m1 maybe_fst in
                    FStar_Errors.Err uu____4937 in
                  FStar_Exn.raise uu____4936
                else ()) verify_flags;
...
let print:
  ...
  fun uu____5038  ->
    ...
    | (make_deps,uu____5062,graph) ->
        let uu____5096 = FStar_Options.dep () in
        (match uu____5096 with
         ...
         | FStar_Pervasives_Native.Some uu____5099 ->
