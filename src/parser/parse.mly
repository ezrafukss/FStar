...
%token QMARK_DOT
%token QMARK
%token SEMICOLON_SEMICOLON EQUALS PERCENT_LBRACK LBRACK_AT DOT_LBRACK DOT_LENS_PAREN_LEFT DOT_LPAREN DOT_LBRACK_BAR LBRACK LBRACK_BAR LBRACE BANG_LBRACE V_LBRACK PIPE_RIGHT
...
%left     OPINFIX0a
%left     OPINFIX0b
%left     OPINFIX0c EQUALS PIPE_RIGHT
%left     OPINFIX0d
(* %left     PIPE_RIGHT *)
%right    OPINFIX1
