...
let assume_strictly_positive_attr_lid = p2l ["Zen"; "Pervasives"; "assume_strictly_positive"]
let unifier_hint_injective_lid = p2l ["Zen"; "Pervasives"; "unifier_hint_injective"]
